...
class TodoTestCase(TestCase):
    ...
    def test_create_todo(self):
        ...
        new_todo = Todo()
        new_todo.titlle = 'Acheter de l\'eau'
        ...
        self.assertTrue(nbr_of_todos_before_add + 1, nbr_of_todos_after_add)
    ...
    def test_delete_todo(self):
        ...
        self.assertEqual(nbr_of_todos_after_delete, nbr_of_todos_before_delete - 1)